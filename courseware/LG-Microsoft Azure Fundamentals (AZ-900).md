...
This Markdown guide mirrors the Learner Guide DOCX and is generated from the same 16 lab markdown files.
...
![Management and Governance Loop](assets/azure-governance-loop.png)

## Lab Alignment Matrix

| Lab | AZ-900 Domain | Title | Source |
| --- | --- | --- | --- |
| 1 | Domain 1 - Describe cloud concepts | Tour the Azure Portal and Create Your First Resource Group | labs/lab-01-azure-portal-tour.md |
| 2 | Domain 1 - Describe cloud concepts | Get Started with Azure Cloud Shell (CLI and PowerShell) | labs/lab-02-cloud-shell-cli.md |
| 3 | Domain 1 - Describe cloud concepts | Explore Regions, Region Pairs and Availability Zones | labs/lab-03-regions-availability-zones.md |
| 4 | Domain 2 - Describe Azure architecture and services | Create a Windows Virtual Machine in the Portal | labs/lab-04-windows-vm-portal.md |
| 5 | Domain 2 - Describe Azure architecture and services | Create a Linux VM with the Azure CLI | labs/lab-05-linux-vm-cli.md |
| 6 | Domain 2 - Describe Azure architecture and services | Create a Web App with Azure App Service | labs/lab-06-app-service-webapp.md |
| 7 | Domain 2 - Describe Azure architecture and services | Deploy a Container with Azure Container Instances | labs/lab-07-container-instances.md |
| 8 | Domain 2 - Describe Azure architecture and services | Create a Virtual Network and Test Private Connectivity | labs/lab-08-virtual-network.md |
| 9 | Domain 2 - Describe Azure architecture and services | Create a Storage Account and Work with Blob Storage | labs/lab-09-storage-blobs.md |
| 10 | Domain 2 - Describe Azure architecture and services | Create an Azure SQL Database | labs/lab-10-azure-sql.md |
| 11 | Domain 2 - Describe Azure architecture and services | Explore Microsoft Entra ID: Users and Groups | labs/lab-11-entra-id.md |
| 12 | Domain 3 - Describe Azure management and governance | Manage Access with Azure RBAC | labs/lab-12-rbac.md |
| 13 | Domain 3 - Describe Azure management and governance | Apply Resource Tags and Resource Locks | labs/lab-13-tags-locks.md |
| 14 | Domain 3 - Describe Azure management and governance | Enforce Standards with Azure Policy | labs/lab-14-azure-policy.md |
| 15 | Domain 3 - Describe Azure management and governance | Estimate and Control Costs: Pricing Calculator, TCO and Budgets | labs/lab-15-cost-management.md |
| 16 | Domain 3 - Describe Azure management and governance | Monitor Your Environment: Advisor, Service Health and Azure Monitor | labs/lab-16-monitoring.md |
...
**Source:** `labs/lab-01-azure-portal-tour.md`
...
**Day:** Day 1  
**Domain:** Domain 1 - Describe cloud concepts  
**Source:** `labs/lab-02-cloud-shell-cli.md`
...
**Day:** Day 1  
**Domain:** Domain 1 - Describe cloud concepts  
**Source:** `labs/lab-03-regions-availability-zones.md`
...
**Day:** Day 1  
**Domain:** Domain 2 - Describe Azure architecture and services  
**Source:** `labs/lab-04-windows-vm-portal.md`
...
**Day:** Day 1  
**Domain:** Domain 2 - Describe Azure architecture and services  
**Source:** `labs/lab-05-linux-vm-cli.md`
...
**Day:** Day 1  
**Domain:** Domain 2 - Describe Azure architecture and services  
**Source:** `labs/lab-06-app-service-webapp.md`
...
**Day:** Day 1  
**Domain:** Domain 2 - Describe Azure architecture and services  
**Source:** `labs/lab-07-container-instances.md`
...
**Day:** Day 1  
**Domain:** Domain 2 - Describe Azure architecture and services  
**Source:** `labs/lab-08-virtual-network.md`
...
**Day:** Day 2  
**Domain:** Domain 2 - Describe Azure architecture and services  
**Source:** `labs/lab-09-storage-blobs.md`
...
**Day:** Day 2  
**Domain:** Domain 2 - Describe Azure architecture and services  
**Source:** `labs/lab-10-azure-sql.md`
...
**Day:** Day 2  
**Domain:** Domain 2 - Describe Azure architecture and services  
**Source:** `labs/lab-11-entra-id.md`
...
**Day:** Day 2  
**Domain:** Domain 3 - Describe Azure management and governance  
**Source:** `labs/lab-12-rbac.md`
...
**Day:** Day 2  
**Domain:** Domain 3 - Describe Azure management and governance  
**Source:** `labs/lab-13-tags-locks.md`
...
**Day:** Day 2  
**Domain:** Domain 3 - Describe Azure management and governance  
**Source:** `labs/lab-14-azure-policy.md`
...
**Day:** Day 2  
**Domain:** Domain 3 - Describe Azure management and governance  
**Source:** `labs/lab-15-cost-management.md`
...
**Day:** Day 2  
**Domain:** Domain 3 - Describe Azure management and governance  
**Source:** `labs/lab-16-monitoring.md`
